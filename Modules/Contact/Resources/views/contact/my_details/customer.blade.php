                ...
                <div class="white_box_50px box_shadow_white">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-lg-3 col-sm-12">
                            <img class="student-meta-img img-100 mb-3" src="{{ file_exists(@$customer->avatar) ? asset(@$customer->avatar) : asset('img/profile.jpg') }}"  alt="">
                            <h3>{{$customer->name}}</h3>
                            <table class="table table-borderless supplier_view">
                                ...
                                <tr><td>{{ __('common.Registered Date') }}:</td><td>{{ showDate($customer->created_at) }}</td></tr>
                                <tr>
...
<script>
    ...
    (function ($){
        ...
        $( "#debit_account_id" ).on("chnage", function() {
