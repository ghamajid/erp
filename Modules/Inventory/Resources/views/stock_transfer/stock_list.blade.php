                                                ...
                                                <td>
                                                    @if (@$product_stock->productSku->product->product_type == "Single")
                                                        <img style="height: 22px;"
                                                             src="{{asset(@$product_stock->productSku->product->image_source ?? 'backEnd/img/no_image.png')}}">
                                                    @else
                                                        <img style="height: 22px;"
                                                             src="{{asset(@$product_stock->productSku->product_variation->image_source ?? 'backEnd/img/no_image.png')}}">
                                                    @endif
                                                </td>
                                                <td>
