                        ...
                        @if ($product->product_type == "Single")
                            @foreach ($product->skus as $key => $sku)
                                <div class="col-xl-4 text-center">
                                    <a href="javascript:void(0)" onclick="selectProduct({{ $sku->id }})"><img src="{{ asset($product->image_source ?? 'backEnd/img/no_image.png') }}" alt="{{$sku->sku}}" id="view_product_image" style="height:200px;width:200px;"></a>
                        ...
                        @else
                            @foreach ($product->skus as $key => $sku)
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 text-center">
                                    <a href="javascript:void(0)" onclick="selectProduct({{ $sku->id }})"><img src="{{ asset($sku->product_variation->image_source ?? 'backEnd/img/no_image.png') }}" id="view_product_image" style="height:150px;width:150px;"></a>
