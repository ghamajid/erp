...
<!doctype html>
<?php
    Illuminate\Support\Facades\Cache::remember('language', 3600 , function() use($lang) {
        return Modules\Localization\Entities\Language::where('code', $lang)->first();
    });
?>
<html <?php if(Illuminate\Support\Facades\Cache::get('language')->rtl == 1): ?> dir="rtl" class="rtl" <?php endif; ?> lang="<?php echo e($lang); ?>" >
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="A fully featured admin theme which can be used to build CRM, CMS, etc.">
    <link rel="icon" href="<?php echo e(asset('uploads/settings/favicon.png')); ?>" type="image/png"/>
    <title><?php echo e(isset($title) ? $title .' | '. $setting->site_title : $setting->site_title); ?></title>
    ...
    <!-- <link rel="stylesheet" href="<?php echo e(asset('backEnd/vendors/css/bootstrap.min.css')); ?>"/> -->
    <link rel="stylesheet" href="<?php echo e(asset('login-asset/css/style.css')); ?>"/>
    <link rel="stylesheet" href="<?php echo e(asset('login-asset/css/login.css')); ?>">
                ...
                <div class="main-content">
                    <div class="logo_img">
                        <a href="<?php echo e(route('home')); ?>">
                            <img src="<?php echo e(asset( $setting->logo )); ?>" alt="Logo Image" class="img img-responsive">
                        </a>
                    </div>
...
<?php /**PATH C:\projects\ERP\InfixBiz V3.3.2\resources\views/auth/layouts/guest.blade.php ENDPATH**/ ?>