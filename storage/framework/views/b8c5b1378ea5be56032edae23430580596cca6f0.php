            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            ...
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('common.Unit Type')); ?></h3>
                                <ul class="d-flex">
                                    <?php if(permissionCheck('unit_type.store')): ?>
                                    <li><a data-toggle="modal" data-target="#Item_Details"
                                           class="primary-btn radius_30px mr-10 fix-gr-bg" href="#"><i
                                                class="ti-plus"></i><?php echo e(__('common.Add Unit Type')); ?></a></li>
                                    <?php endif; ?>
                                        <?php if(permissionCheck('unit_type.csv_upload.store')): ?>
                                    <li><a class="primary-btn radius_30px mr-10 fix-gr-bg"
                                           href="<?php echo e(route('unit_type.csv_upload.create')); ?>"><i
                        ...
                        <div class="QA_table ">
                            ...
                            <div class="">
                                <div id="unit_type_list">
                                    <?php echo $__env->make('product::unit_type.unit_type_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal_800px modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"><?php echo e(__('common.Add Unit Type')); ?></h4>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input name="name" class="primary_input_field"
                                                       placeholder="<?php echo e(__('product.Unit Type Name')); ?>"
                                                       type="text" required>
                                        ...
                                        <div class="col-lg-12 text-center">
                                            <div class="d-flex justify-content-center pt_20">
                                                <button type="submit" class="primary-btn semi_large2  fix-gr-bg"
                                                        ...
                                                        class="ti-check"></i><?php echo e(__('common.Add Unit Type')); ?>
                ...
                <div class="modal fade admin-query" id="Item_Edit">
                    <div class="modal-dialog modal_800px modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"><?php echo e(__('common.Edit Unit Type')); ?></h4>
                                <button type="button" class="close " data-dismiss="modal">
                                    <i class="ti-close "></i>
                                </button>
                            </div>
            ...
            (function ($){
                ...
                $(document).ready(function () {
                    ...
                    $("#unitTypeForm").on("submit", function (event) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route("unit_type.store")); ?>",
                            data: formData,
                            type: "POST",
                    ...
                    $("#myInput").on('keyup', function (event) {
                        ...
                        if (event.keyCode === 13) {
                            $.ajax({
                                url: "<?php echo e(route("unit_type.get_list")); ?>" + '?search_keyword=' + search_keyword,
                                type: "GET",
                                dataType: "HTML",
                                success: function (response) {
                    ...
                    function unitTypeList() {
                        $.ajax({
                            url: "<?php echo e(route("unit_type.get_list")); ?>",
                            type: "GET",
                            dataType: "HTML",
                            success: function (response) {
                                $("#unit_type_list").html(response);
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\ERP\InfixBiz V3.3.2\resources\views/modules/product/unit_type/unit_type.blade.php ENDPATH**/ ?>