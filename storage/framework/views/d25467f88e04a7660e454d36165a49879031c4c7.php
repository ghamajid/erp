...
<div class="main-title mb-25">
    <h3 class="mb-0"><?php echo e(__('setting.SMTP Settings')); ?></h3>
</div>
        ...
        <div class="col-xl-12">
            <div class="primary_input">
                ...
                <select class="primary_select mb-25" name="mail_protocol" onchange="smtp_form()" id="mail_mailer">
                    <option value="smtp" <?php if(app('general_setting')->mail_protocol == "smtp"): ?> selected <?php endif; ?>>SMTP</option>
                    <option value="sendmail" <?php if(app('general_setting')->mail_protocol == "sendmail"): ?> selected <?php endif; ?>>Send Mail</option>
                </select>
            </div>
        </div>
    </div>
    <div class="row" id="smtp">
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                ...
                <input class="primary_input_field" placeholder="Infix CRM" type="text" name="MAIL_FROM_NAME" value="<?php echo e(env('MAIL_FROM_NAME')); ?>">
            </div>
        </div>
    ...
    <div class="row" id="sendmail">
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                ...
                <input class="primary_input_field" placeholder="-" type="text" name="MAIL_FROM_NAME" value="<?php echo e(env('MAIL_FROM_NAME')); ?>">
            </div>
        </div>
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                ...
                <label class="primary_input_label" for=""><?php echo e(__('setting.Sender Email')); ?></label>
                <input class="primary_input_field" placeholder="-" type="text" name="SENDER_MAIL" value="<?php echo e(env('MAIL_FROM_ADDRESS')); ?>">
            </div>
        </div>
    </div>
    <div class="row">
...
<?php if(permissionCheck('test_mail.send')): ?>

<form class="" action="<?php echo e(route('test_mail.send')); ?>" method="post">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-xl-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for=""><?php echo e(__('setting.Send a Test Email to')); ?></label>
                <input class="primary_input_field" type="text" name="email" placeholder="Email to" required>
            </div>
        </div>
        <div class="col-xl-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for=""><?php echo e(__('setting.Mail Text')); ?></label>
                <input class="primary_input_field" placeholder="-" type="text" name="content" required>
            </div>
        </div>
    </div>
    <div class="submit_btn text-center mb-100 pt_15">
        <button class="primary_btn_2" type="submit"><?php echo e(__('setting.Send Test Mail')); ?></button>
    </div>
</form>

<?php endif; ?>
<!--/ SMTP_form  -->
<?php /**PATH C:\projects\ERP\InfixBiz V3.3.2\resources\views/modules/setting/page_components/smtp_setting.blade.php ENDPATH**/ ?>