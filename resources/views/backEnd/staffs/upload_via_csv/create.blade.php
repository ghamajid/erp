                        ...
                        <div class="white_box_50px box_shadow_white">
                            ...
                            <div class="box_header d-block">
                                <div class="main-title d-flex flex-wrap">
                                    <h3 class="mb-0 mr-30 text-nowrap">{{ __('common.Upload Staff Via CSV')}}</h3>
                                    <div class="d-flex justify-content-end align-items-center  flex-wrap flex-grow-1">
                                        <ul class="d-flex flex-wrap">
                                            <li><a download class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{ asset('uploads/staff.xlsx') }}"><i class="ti-import"></i>{{ __('common.Sample File Download') }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <form action="{{route("staffs.csv_upload.store")}}" method="POST" enctype="multipart/form-data" class="csvForm">
                                @csrf
                                <div class="row form">
