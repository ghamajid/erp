...
<script src="{{ asset('backEnd/vendors/js/loadah.min.js') }}"></script>
<script>
...
<!-- nestable  -->
<script src="{{asset('frontend/vendors/nestable/jquery.nestable.js')}}"></script>

<!-- chage  -->
<script src="{{asset('backEnd/vendors/js/fullcalendar.min.js')}}"></script>
<script src="{{asset('backEnd/vendors/js/fullcallendar-locale-all.js')}}"></script>

<!-- metisMenu js  -->
<script src="{{asset('frontend/js/metisMenu.js')}}"></script>

<!-- progressbar  -->
<script src="{{asset('frontend/vendors/progressbar/circle-progress.min.js')}}"></script>
<!-- color picker  -->
<script src="{{asset('frontend/vendors/color_picker/colorpicker.min.js')}}"></script>
<script src="{{asset('frontend/vendors/color_picker/examples_colorpicker.js')}}"></script>
