                        ...
                        <div class="white-box single-summery">
                            <div class="d-block mt-10">
                                ...
                                <img class="demo_wait" height="60px" style="display: none"
                                     src="{{asset('backEnd/img/loader.gif')}}" alt="">
                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="white_box_30px mb_30">
                        <div class="box_header common_table_header mb-40 flex-wrap">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('dashboard.Branch Wise Product Quantity')}}</h3>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('js/charts_loader.js') }}"></script>
    @if (permissionCheck('sale_statistics'))
