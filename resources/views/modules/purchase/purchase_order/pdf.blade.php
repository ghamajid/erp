...
<footer class="invoice_footer">
    <div class="invoice_info_footer">
        ...
        <div class="invoice_logo text-center">
            <img
                src="{{ $data->user->signature ? asset($data->user->signature) : asset('frontend/img/signature.png') }}"
                alt="">
            <p style="margin-bottom:5px">--------------------------</p>
        ...
        <div class="invoice_logo text-center">
            <img
                src="{{  $data->updater->signature ? asset($data->updater->signature) : asset('frontend/img/signature.png') }}"
                alt="">
            <p style="margin-bottom:5px">--------------------------</p>
