                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade show active a4_width" id="invoice">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12">
                                        <table class="table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td>: {{ showDate($quotation->created_at) }}</td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="row mt-60 signature_bottom">
                                ...
                                <div class="col-md-4 text-center">
                                    <img src="{{ $quotation->creator->signature ? asset($quotation->creator->signature) : asset('frontend/img/signature.png') }}" alt="">
                                    <p>--------------------------</p>
                                    <p>{{__('sale.Accountant')}}</p>
                                    <p>{{__('sale.Signature')}}</p>
                                </div>
                                <div class="col-md-4 text-center">
                                    <img  src="{{ $quotation->updator->signature ? asset($quotation->updator->signature) : asset('frontend/img/signature.png') }}" alt="">
                                    <p>--------------------------</p>
