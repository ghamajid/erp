                        ...
                        <form action="{{route("sale.quotation_to_store")}}" method="POST" enctype="multipart/form-data" id="saleForm">
                                    ...
                                    <div class="primary_input mb-15">
                                        ...
                                        <select class="primary_select mb-15 product_info" id="product_info"
                                            ...
                                            @foreach ($allServices as $product)
                                                <option
                                                    value="{{$product->product_id}}-{{ $product->product_type }}">{{$product->product_name}} </option>
                                            @endforeach
                                        </select>
                                        <span class="text-danger">{{$errors->first('product_id')}}</span>
                                    </div>
                            ...
                            <table class="table ">
                                ...
                                <tr>
                                    ...
                                    <th class="last_price d-none" scope="col"><a href="javascript:void(0)" onclick="invoiceDetail()">{{__('sale.Last Price')}}</a></th>
