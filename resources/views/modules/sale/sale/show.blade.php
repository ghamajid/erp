                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-12">
                                            <table class="table-borderless mr-0 ml-auto">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>: @if ($sale->type == 1) {{ __('common.Regular') }} @elseif ($sale->type == 2) {{ __('common.Affiliate') }} @elseif ($sale->type == 3) {{ __('common.Commissioner') }} @else {{ __('common.POS') }}@endif</td>
                                                </tr>
                                            </table>
                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right mr-0 pr-2">
                                                                    <ul>
                                                                        ...
                                                                        @endif
                                                                        @if($due > 0)
                                                                            <li class="border-top-0 total_due" style="display: none">{{single_price($due)}}</li>
                                                                        @endif
                                                                    </ul>
                                                                </td>
                                                            </tr>
